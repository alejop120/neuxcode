...
class StudentHasSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_has_subject" do
    assert_difference('StudentHasSubject.count') do
      post student_has_subjects_url, params: { student_has_subject: { student_id: @student_has_subject.student_id, subject_id: @student_has_subject.subject_id } }
    end
  ...
  test "should update student_has_subject" do
    patch student_has_subject_url(@student_has_subject), params: { student_has_subject: { student_id: @student_has_subject.student_id, subject_id: @student_has_subject.subject_id } }
